...
import { AAWidgetProps, AAWidget } from "./AAWidget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  return class AAWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): AAWidgetProps {
      const attrs = this.parseAttributes<AAWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<AAWidget {...this.props} />, container);
    }
...
const blockDefinition: BlockDefinition = {
    ...
    uiSchema: uiSchema,
    label: 'AAWidget',
    iconUrl: "https://conwabueze.github.io/sb-aa-widget/resources/aa-icon.png",
};
